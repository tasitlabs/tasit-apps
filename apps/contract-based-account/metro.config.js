...
const extraNodeModules = {
  "@tasit/account": path.resolve(
    __dirname + "/../../../tasit-sdk/packages/account"
  ),
  "@tasit/action": path.resolve(
    __dirname + "/../../../tasit-sdk/packages/action"
  ),
  "@tasit/contracts": path.resolve(
    __dirname + "/../../../tasit-sdk/packages/contracts"
  ),
  "@tasit/contract-based-account": path.resolve(
    __dirname + "/../../../tasit-sdk/packages/contract-based-account"
  ),
  "@tasit/hooks": path.resolve(
    __dirname + "/../../../tasit-sdk/packages/hooks"
  ),
